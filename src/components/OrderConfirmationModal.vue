...
import ConfirmedOrderList from '@/components/ConfirmedOrderList.vue';
  ...
  <TransitionRoot appear :show="props.open" as="template">
    <Dialog as="div" @close="$emit('close')" class="relative z-10">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div class="flex min-h-full items-end justify-center pt-20 md:items-center md:py-10">
          <TransitionChild
            as="template"
            enter="duration-300 ease-out"
            ...
            <DialogPanel
              class="w-full transform overflow-hidden rounded-t-xl bg-white px-6 pt-10 pb-6 transition-all md:max-w-2xl md:flex-1 md:rounded-xl md:p-10 lg:max-w-xl">
              <svg
                width="48"
                height="48"
                viewBox="0 0 48 48"
              ...
              <DialogTitle as="h3" class="text-preset-1 mt-6 text-rose-900">
                Order Confirmed
              </DialogTitle>
              <DialogDescription class="mt-2 text-base text-rose-500">
                We hope you enjoy your food!
              </DialogDescription>
              <ConfirmedOrderList />
              <button
                type="button"
                class="text-preset-3 bg-red hover:bg-red/95 mt-8 block w-full rounded-full p-4 text-center text-white"
